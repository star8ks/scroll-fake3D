...
const appleSequenceImages = Array.from({ length: 33 }, (_, i) => `${i.toString().padStart(4, '0')}.webp`);
// const appleSequenceImages = ['Borges.jpg'];

const HomePage: React.FC = () => {
  return (
    <div className={styles.container}>
      <section className={`${styles.scrollSequenceContainer} ${styles.appleContainer}`}>
        <ScrollSequence
        ...
        <div className={styles.scrollSequenceContent}>
          <Element name="scrollSequence" className={styles.speak}>
          </Element>
          <Element name="textAnimation" className={styles.speak}>
          </Element>
        </div>
      </section>

      <section className={styles.additionalSection}>
        <Element name="finalThoughts" className={styles.speak}>
        </Element>
      </section>
    </div>
  );
